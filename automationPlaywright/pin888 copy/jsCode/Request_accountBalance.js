// Request_accountBalance.js - 获取账户余额
...
try {
    ...
    // 构造请求URL
    const url = `https://www.pin880.com/member-service/v2/account-balance?locale=en_US&_=${timestamp}&withCredentials=true`;
    ...
    console.error('Request_accountBalance错误:', error);
    return {
        error: error.message,
        status: 0,
        timestamp: new Date().toISOString()
